  ...
  <v-card justify="center">
    <v-dialog v-model="dialog" persistent max-width="600px">
      <template v-slot:activator="{ on, attrs }">
        <v-btn color="primary" dark v-bind="attrs" v-on="on"> Поиск </v-btn>
      </template>
      <v-card>
        <v-card-title>
        ...
        <v-card-text>
          <v-container>
            <v-row>
              ...
              <v-col cols="12" sm="6">
                <v-text-field v-model="params.page">
                  <template v-slot:label> Страница </template>
                </v-text-field>
              </v-col>
              <v-col cols="12" sm="6">
                <v-select
        ...
        <v-card-actions>
          ...
          <v-btn color="blue darken-1" text @click="search"> Поиск </v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </v-card>
